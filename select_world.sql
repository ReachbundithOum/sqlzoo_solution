...
--#4/
    SELECT name,population,population / 1000000
    FROM world
...
--#9/
    SELECT name,population,ROUND(population/1000000,2),ROUND(population/1000000000,2)
    FROM world
    WHERE continent = 'South America';
...
--#10/
    SELECT name, ROUND(gdp/population, -3) * 1000 
    FROM world
